...
class BoekkooiTwigJackExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoad()
    {
        ...
        $this->assertFalse($container->has('boekkooi.twigjack.constraint_validator'));
    ...
    public function testLoadConstraint($options, $envServiceName)
    {
        ...
        $this->assertTrue($container->has('boekkooi.twigjack.constraint_validator'));

        /** @var \Symfony\Component\DependencyInjection\Reference $envReference */
        $envReference = $container->getDefinition('boekkooi.twigjack.constraint_validator')->getArgument(0);
